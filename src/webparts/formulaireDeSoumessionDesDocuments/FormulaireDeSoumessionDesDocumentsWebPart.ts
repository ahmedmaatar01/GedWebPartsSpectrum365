...
import { SPOperations } from '../Services/SpFormulaireSoumessionService';


import * as strings from 'FormulaireDeSoumessionDesDocumentsWebPartStrings';
import FormulaireDeSoumessionDesDocuments from './components/FormulaireDeSoumessionDesDocuments';
import { IFormulaireDeSoumessionDesDocumentsProps } from './components/IFormulaireDeSoumessionDesDocumentsProps';

export interface IFormulaireDeSoumessionDesDocumentsWebPartProps {
  description: string;
...
export default class FormulaireDeSoumessionDesDocumentsWebPart extends BaseClientSideWebPart<IFormulaireDeSoumessionDesDocumentsWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IFormulaireDeSoumessionDesDocumentsProps> = React.createElement(
      FormulaireDeSoumessionDesDocuments,
      {
