...
import * as strings from 'TableauDeBoardWebPartStrings';
import TableauDeBoard from './components/TableauDeBoard';
import { ItableauDeBoardProps } from './components/ITableauDeBoardProps';

export interface ITableauDeBoardWebPartProps {
  description: string;
...
export default class TableauDeBoardWebPart extends BaseClientSideWebPart<ITableauDeBoardWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<ItableauDeBoardProps> = React.createElement(
      TableauDeBoard,
      {
