// Main Component (tableauDeBoard)

import * as React from 'react';
import styles from './TableauDeBoard.module.scss';
import type { ItableauDeBoardProps } from './ITableauDeBoardProps';
import { ItableauDeBoardState } from './ITableauDeBoardState';
import { SPOperations, SPListColumn } from "../../Services/SpTableauDeBoardService";
import { escape } from '@microsoft/sp-lodash-subset';
import TableRender from './TableRender/TableRender';

export default class tableauDeBoard extends React.Component<
  ItableauDeBoardProps,
  ItableauDeBoardState,
  { showModal: boolean }
> {
  ...
  constructor(props: ItableauDeBoardProps) {
    super(props);
  ...
  public componentDidUpdate(prevProps: ItableauDeBoardProps) {
  ...
  public render(): React.ReactElement<ItableauDeBoardProps> {
    ...
    return (
      <section className={`${styles.tableauDeBoard} ${hasTeamsContext ? styles.teams : ''}`}>
